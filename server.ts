...
function getCashfreeConfig() {
    ...
    const isProd = cfEnv === "PROD" || cfEnv === "PRODUCTION";
    return {
        cfEnv: isProd ? "PROD" : "TEST",
        baseUrl: isProd ? "https://api.cashfree.com/pg" : "https://sandbox.cashfree.com/pg",
        appId: process.env.CASHFREE_CLIENT_ID || "TEST1032840428d095908b8b0908861140482301",
        secretKey: process.env.CASHFREE_CLIENT_SECRET || "cfsecret_abc123demo",
...
app.post("/api/cashfree/create-order", async (req: any, res: any) => {
    try {
        ...
        const { cfEnv, baseUrl, appId, secretKey } = getCashfreeConfig();
